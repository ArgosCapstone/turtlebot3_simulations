...
def generate_launch_description():
    ...
    robot_state_publisher_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={'use_sim_time': use_sim_time, 'robot_model': turtlebot3_model}.items()
    )
    ...
    ld.add_action(DeclareLaunchArgument('TURTLEBOT3_MODEL', default_value='waffle'))
    ld.add_action(DeclareLaunchArgument('scale_factor', default_value='3.0'))
